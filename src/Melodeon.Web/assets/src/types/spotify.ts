declare global {
    ...
    namespace Spotify {
        ...
        class Player {
            ...
            disconnect(): void;
            on(
                errorName: WebPlaybackErrorName,
                callback: (e: WebPlaybackError) => void,
            ): void;
            addListener<K extends keyof WebPlaybackEventNameMap>(
                eventName: K,
                callback: (e: WebPlaybackEventNameMap[K]) => void,
            ): void;
            removeListener<K extends keyof WebPlaybackEventNameMap>(
                eventName: K,
            ): void;
